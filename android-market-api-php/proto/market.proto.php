...
// enum MK_AppsRequest.OrderType
class MK_AppsRequest_OrderType {
  const NONE = 0;
  const POPULAR = 1;
  const NEWEST = 2;
  const FEATURED = 3;
...
// enum MK_AppsRequest.ViewType
class MK_AppsRequest_ViewType {
  const ALL = 0;
  const FREE = 1;
  const PAID = 2;
...
// message MK_AppsRequest
class MK_AppsRequest {
  private $_unknown;
  ...
  public function __toString() {
    return ''
         ...
         . Protobuf::toString('appType_', MK_AppType::toString($this->appType_))
         ...
         . Protobuf::toString('orderType_', MK_AppsRequest_OrderType::toString($this->orderType_))
         . Protobuf::toString('startIndex_', $this->startIndex_)
         . Protobuf::toString('entriesCount_', $this->entriesCount_)
         . Protobuf::toString('viewType_', MK_AppsRequest_ViewType::toString($this->viewType_));
  }
  ...
  public function getAppType() { if($this->appType_ === null) return MK_AppType::NONE; else return $this->appType_; }
  ...
  public function getOrderType() { if($this->orderType_ === null) return MK_AppsRequest_OrderType::NONE; else return $this->orderType_; }
  ...
  public function getViewType() { if($this->viewType_ === null) return MK_AppsRequest_ViewType::ALL; else return $this->viewType_; }
  public function setViewType($value) { $this->viewType_ = $value; }
  
  // @@protoc_insertion_point(class_scope:AppsRequest)
}

// message MK_AppsResponse
class MK_AppsResponse {
  private $_unknown;
      ...
      switch($field) {
        ...
        case 8:
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->subCategories_[] = new MK_Category($fp, $len);
          ASSERT('$len == 0');
          break;
        default:
          $this->_unknown[$field . '-' . Protobuf::get_wiretype($wire)][] = Protobuf::read_field($fp, $wire, $limit);
...
// message MK_CommentsRequest
class MK_CommentsRequest {
  private $_unknown;
...
// message MK_CommentsResponse
class MK_CommentsResponse {
  private $_unknown;
      ...
      switch($field) {
        case 1:
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->comments_[] = new MK_Comment($fp, $len);
          ASSERT('$len == 0');
          break;
        case 2:
          ASSERT('$wire == 0');
...
// group MK_App.ExtendedInfo
class MK_App_ExtendedInfo {
  private $_unknown;
...
class MK_App {
  ...
  function read($fp, &$limit = PHP_INT_MAX) {
    while(!feof($fp) && $limit > 0) {
      ...
      switch($field) {
        ...
        case 12:
          ASSERT('$wire == 3');
          $this->extendedinfo_ = new MK_App_ExtendedInfo($fp, $limit);
          break;
        case 22:
          ASSERT('$wire == 2');
          $len = Protobuf::read_varint($fp, $limit);
  ...
  public function setExtendedinfo(MK_App_ExtendedInfo $value) { $this->extendedinfo_ = $value; }
...
// message MK_CategoriesRequest
class MK_CategoriesRequest {
  private $_unknown;
...
// message MK_CategoriesResponse
class MK_CategoriesResponse {
  private $_unknown;
      ...
      switch($field) {
        case 1:
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->categories_[] = new MK_Category($fp, $len);
          ASSERT('$len == 0');
          break;
        default:
          $this->_unknown[$field . '-' . Protobuf::get_wiretype($wire)][] = Protobuf::read_field($fp, $wire, $limit);
...
// message MK_SubCategoriesRequest
class MK_SubCategoriesRequest {
  private $_unknown;
...
// message MK_SubCategoriesResponse
class MK_SubCategoriesResponse {
  private $_unknown;
      ...
      switch($field) {
        case 1:
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->category_[] = new MK_Category($fp, $len);
          ASSERT('$len == 0');
          break;
        case 2:
          ASSERT('$wire == 2');
...
// message MK_RequestContext
class MK_RequestContext {
  private $_unknown;
...
// enum MK_GetImageRequest.AppImageUsage
class MK_GetImageRequest_AppImageUsage {
  const ICON = 0;
  const SCREENSHOT = 1;
...
// message MK_GetImageRequest
class MK_GetImageRequest {
  private $_unknown;
  ...
  public function __toString() {
    return ''
         . Protobuf::toString('unknown', $this->_unknown)
         . Protobuf::toString('appId_', $this->appId_)
         . Protobuf::toString('imageUsage_', MK_GetImageRequest_AppImageUsage::toString($this->imageUsage_))
  ...
  public function getImageUsage() { if($this->imageUsage_ === null) return MK_GetImageRequest_AppImageUsage::ICON; else return $this->imageUsage_; }
...
// message MK_GetImageResponse
class MK_GetImageResponse {
  private $_unknown;
...
// group MK_Request.RequestGroup
class MK_Request_RequestGroup {
  private $_unknown;
      ...
      switch($field) {
        ...
        case 4:
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->appsRequest_ = new MK_AppsRequest($fp, $len);
          ASSERT('$len == 0');
          break;
        case 5:
          ASSERT('$wire == 2');
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->commentsRequest_ = new MK_CommentsRequest($fp, $len);
          ASSERT('$len == 0');
          break;
        case 11:
          ASSERT('$wire == 2');
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->imageRequest_ = new MK_GetImageRequest($fp, $len);
          ASSERT('$len == 0');
          break;
        case 14:
          ASSERT('$wire == 2');
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->subCategoriesRequest_ = new MK_SubCategoriesRequest($fp, $len);
          ASSERT('$len == 0');
          break;
        case 21:
          ASSERT('$wire == 2');
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->categoriesRequest_ = new MK_CategoriesRequest($fp, $len);
          ASSERT('$len == 0');
          break;
        default:
          $this->_unknown[$field . '-' . Protobuf::get_wiretype($wire)][] = Protobuf::read_field($fp, $wire, $limit);
  ...
  public function setAppsRequest(MK_AppsRequest $value) { $this->appsRequest_ = $value; }
  ...
  public function setCommentsRequest(MK_CommentsRequest $value) { $this->commentsRequest_ = $value; }
  ...
  public function setImageRequest(MK_GetImageRequest $value) { $this->imageRequest_ = $value; }
  ...
  public function setSubCategoriesRequest(MK_SubCategoriesRequest $value) { $this->subCategoriesRequest_ = $value; }
  ...
  public function setCategoriesRequest(MK_CategoriesRequest $value) { $this->categoriesRequest_ = $value; }
...
class MK_Request {
      ...
      switch($field) {
        case 1:
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->context_ = new MK_RequestContext($fp, $len);
          ASSERT('$len == 0');
          break;
        case 2:
          ASSERT('$wire == 3');
          $this->requestgroup_[] = new MK_Request_RequestGroup($fp, $limit);
          break;
        default:
          $this->_unknown[$field . '-' . Protobuf::get_wiretype($wire)][] = Protobuf::read_field($fp, $wire, $limit);
      }
  ...
  public function setContext(MK_RequestContext $value) { $this->context_ = $value; }
  
  // repeated group MK_RequestGroup = 2
...
// message MK_ResponseContext
class MK_ResponseContext {
  private $_unknown;
...
// group MK_Response.ResponseGroup
class MK_Response_ResponseGroup {
  private $_unknown;
      ...
      switch($field) {
        ...
        case 2:
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->context_ = new MK_ResponseContext($fp, $len);
          ASSERT('$len == 0');
          break;
        case 3:
          ASSERT('$wire == 2');
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->appsResponse_ = new MK_AppsResponse($fp, $len);
          ASSERT('$len == 0');
          break;
        case 4:
          ASSERT('$wire == 2');
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->commentsResponse_ = new MK_CommentsResponse($fp, $len);
          ASSERT('$len == 0');
          break;
        case 10:
          ASSERT('$wire == 2');
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->imageResponse_ = new MK_GetImageResponse($fp, $len);
          ASSERT('$len == 0');
          break;
        case 20:
          ASSERT('$wire == 2');
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->categoriesResponse_ = new MK_CategoriesResponse($fp, $len);
          ASSERT('$len == 0');
          break;
        case 13:
          ASSERT('$wire == 2');
          ...
          if ($len === false)
            throw new Exception('Protobuf::read_varint returned false');
          $limit-=$len;
          $this->subCategoriesResponse_ = new MK_SubCategoriesResponse($fp, $len);
          ASSERT('$len == 0');
          break;
        default:
          $this->_unknown[$field . '-' . Protobuf::get_wiretype($wire)][] = Protobuf::read_field($fp, $wire, $limit);
  ...
  public function hasContext() { return $this->context_ !== null; }
  public function getContext() { if($this->context_ === null) return null; else return $this->context_; }
  public function setContext(MK_ResponseContext $value) { $this->context_ = $value; }
  ...
  public function setAppsResponse(MK_AppsResponse $value) { $this->appsResponse_ = $value; }
  ...
  public function setCommentsResponse(MK_CommentsResponse $value) { $this->commentsResponse_ = $value; }
  ...
  public function setImageResponse(MK_GetImageResponse $value) { $this->imageResponse_ = $value; }
  ...
  public function setCategoriesResponse(MK_CategoriesResponse $value) { $this->categoriesResponse_ = $value; }
  ...
  public function setSubCategoriesResponse(MK_SubCategoriesResponse $value) { $this->subCategoriesResponse_ = $value; }
...
class MK_Response {
  ...
  function read($fp, &$limit = PHP_INT_MAX) {
    while(!feof($fp) && $limit > 0) {
      ...
      switch($field) {
        case 1:
          ASSERT('$wire == 3');
          $this->responsegroup_[] = new MK_Response_ResponseGroup($fp, $limit);
          break;
        default:
          $this->_unknown[$field . '-' . Protobuf::get_wiretype($wire)][] = Protobuf::read_field($fp, $wire, $limit);
      }
  ...
  // repeated group MK_ResponseGroup = 1
